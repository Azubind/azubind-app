...
async function renderCompanyApplications(userId,box){
 ...
 box.querySelectorAll(".company-delete").forEach(btn=>btn.addEventListener("click",()=>deleteCompanyApplication(Number(btn.dataset.id),btn,userId)));\n const form=box.querySelector(".company-application-form");
